...
$page_title = "Add New Car Body Type";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        $stmt = $pdo->prepare("SELECT COUNT(*) FROM car_body_types WHERE name = :name OR slug = :slug");
        ...
        error_log("Database error checking duplicate category: " . $e->getMessage());
    ...
    if (empty($errors)) {
        try {
            $stmt = $pdo->prepare("INSERT INTO car_body_types (name, icon_class, slug, Description, created_at) VALUES (:name, :icon_class, :slug, :description, NOW())");
            $stmt->bindParam(':name', $name);
            ...
            if ($stmt->execute()) {
                $_SESSION['success_message'] = "Car body type '{$name}' added successfully!";
                header('Location: categories.php');
                exit();
            } else {
                $_SESSION['error_message'] = "Failed to add car body type.";
            }
        } catch (PDOException $e) {
...
if (isset($_SESSION['user_id'])) {
    ...
    try {
        ...
        error_log("Database error fetching admin name/avatar for add_category.php: " . $e->getMessage());
    }
}

// --- Unread Counts (reused from other admin pages) ---
...
if (isset($_SESSION['user_id'])) {
    ...
    try {
        ...
        error_log("Error fetching unread counts in add_category.php: " . $e->getMessage());
    }
}
...
<head>
    ...
    <title><?php echo $page_title; ?> - Ubuntu Wheels Admin</title>
                ...
                <div class="form-container">
                    ...
                    <form action="add_category.php" method="POST">
                        ...
                        <div class="form-actions">
                            <button type="submit" class="btn btn-primary"><i class="fas fa-plus"></i> Add Body Type</button>
